 ...
 * Original file: /Users/furqaanali/Documents/Semesters/Fall 2020/CS 478/Sample Apps/Services/FunClient/app/src/main/aidl/myAPI/FunCenterFunctions.aidl
 */
package myAPI;
public interface FunCenterFunctions extends android.os.IInterface
{
/** Local-side IPC implementation stub class. */
public static abstract class Stub extends android.os.Binder implements myAPI.FunCenterFunctions
{
private static final java.lang.String DESCRIPTOR = "myAPI.FunCenterFunctions";
...
/**
 * Cast an IBinder object into an myAPI.FunCenterFunctions interface,
 * generating a proxy if needed.
 */
public static myAPI.FunCenterFunctions asInterface(android.os.IBinder obj)
{
if ((obj==null)) {
return null;
}
android.os.IInterface iin = obj.queryLocalInterface(DESCRIPTOR);
if (((iin!=null)&&(iin instanceof myAPI.FunCenterFunctions))) {
return ((myAPI.FunCenterFunctions)iin);
}
return new myAPI.FunCenterFunctions.Stub.Proxy(obj);
}
...
private static class Proxy implements myAPI.FunCenterFunctions
{
