...
public final class R {
  ...
  public static final class drawable {
    ...
    public static final int image1=0x7f040001;
    public static final int image2=0x7f040002;
    public static final int image3=0x7f040003;
  ...
  public static final class raw {
    ...
    public static final int audio2=0x7f080001;
    public static final int audio3=0x7f080002;
  }
  ...
  public static final class styleable {
     ...
     * <tr><td><code>{@link #ColorStateListItem_alpha course.examples.Services.KeyService:alpha}</code></td><td>Alpha multiplier applied to the base color.</td></tr>
     * </table>
     ...
     * <p>May be a floating point value, such as "<code>1.2</code>".
     *
     * @attr name course.examples.Services.KeyService:alpha
     */
     ...
     * <colgroup align="left" />
     * <tr><th>Attribute</th><th>Description</th></tr>
     * <tr><td><code>{@link #FontFamily_fontProviderAuthority course.examples.Services.KeyService:fontProviderAuthority}</code></td><td>The authority of the Font Provider to be used for the request.</td></tr>
     * <tr><td><code>{@link #FontFamily_fontProviderCerts course.examples.Services.KeyService:fontProviderCerts}</code></td><td>The sets of hashes for the certificates the provider should be signed with.</td></tr>
     * <tr><td><code>{@link #FontFamily_fontProviderFetchStrategy course.examples.Services.KeyService:fontProviderFetchStrategy}</code></td><td>The strategy to be used when fetching font data from a font provider in XML layouts.</td></tr>
     * <tr><td><code>{@link #FontFamily_fontProviderFetchTimeout course.examples.Services.KeyService:fontProviderFetchTimeout}</code></td><td>The length of the timeout during fetching.</td></tr>
     * <tr><td><code>{@link #FontFamily_fontProviderPackage course.examples.Services.KeyService:fontProviderPackage}</code></td><td>The package for the Font Provider to be used for the request.</td></tr>
     * <tr><td><code>{@link #FontFamily_fontProviderQuery course.examples.Services.KeyService:fontProviderQuery}</code></td><td>The query to be sent over to the provider.</td></tr>
     * </table>
     ...
     * '\\n' or '\\uxxxx' for a unicode character;
     *
     * @attr name course.examples.Services.KeyService:fontProviderAuthority
     */
     ...
     * "<code>?[<i>package</i>:]<i>type</i>/<i>name</i></code>".
     *
     * @attr name course.examples.Services.KeyService:fontProviderCerts
     */
     ...
     * </table>
     *
     * @attr name course.examples.Services.KeyService:fontProviderFetchStrategy
     */
     ...
     * </table>
     *
     * @attr name course.examples.Services.KeyService:fontProviderFetchTimeout
     */
     ...
     * '\\n' or '\\uxxxx' for a unicode character;
     *
     * @attr name course.examples.Services.KeyService:fontProviderPackage
     */
     ...
     * '\\n' or '\\uxxxx' for a unicode character;
     *
     * @attr name course.examples.Services.KeyService:fontProviderQuery
     */
     ...
     * <tr><td><code>{@link #FontFamilyFont_font course.examples.Services.KeyService:font}</code></td><td>The reference to the font file to be used.</td></tr>
     * <tr><td><code>{@link #FontFamilyFont_fontStyle course.examples.Services.KeyService:fontStyle}</code></td><td>The style of the given font file.</td></tr>
     * <tr><td><code>{@link #FontFamilyFont_fontVariationSettings course.examples.Services.KeyService:fontVariationSettings}</code></td><td>The variation settings to be applied to the font.</td></tr>
     * <tr><td><code>{@link #FontFamilyFont_fontWeight course.examples.Services.KeyService:fontWeight}</code></td><td>The weight of the given font file.</td></tr>
     * <tr><td><code>{@link #FontFamilyFont_ttcIndex course.examples.Services.KeyService:ttcIndex}</code></td><td>The index of the font in the tcc font file.</td></tr>
     * </table>
     ...
     * "<code>?[<i>package</i>:]<i>type</i>/<i>name</i></code>".
     *
     * @attr name course.examples.Services.KeyService:font
     */
     ...
     * </table>
     *
     * @attr name course.examples.Services.KeyService:fontStyle
     */
     ...
     * '\\n' or '\\uxxxx' for a unicode character;
     *
     * @attr name course.examples.Services.KeyService:fontVariationSettings
     */
     ...
     * <p>May be an integer value, such as "<code>100</code>".
     *
     * @attr name course.examples.Services.KeyService:fontWeight
     */
     ...
     * <p>May be an integer value, such as "<code>100</code>".
     *
     * @attr name course.examples.Services.KeyService:ttcIndex
     */
